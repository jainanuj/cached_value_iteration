...
perf stat -e task-clock,cycles,instructions,cache-references,cache-misses ./solve -p ../MDPs/evaluated/dap_100x100x10x10.mdp -method ftvi >op_dap_100x100x10x10_clust_anneal 2>dap_100_clust_ann_perf
#clust and 4M
...
perf stat -e task-clock,cycles,instructions,cache-references,cache-misses ./solve -p ../MDPs/evaluated/dap_200x100x10x10.mdp -method ftvi > op_dap_200x100x10x10_clust_anneal 2>dap_200_clust_ann_perf
...
perf stat -e task-clock,cycles,instructions,cache-references,cache-misses ./solve -p ../MDPs/evaluated/dap_100x100x10x10.mdp -method ftvi >op_dap_100x100x10x10_clust_noanneal 2>dap_100_clust_noann_perf
#clust and 4M
cp solve.c.4MInitial solve.c
make clean
make
...
perf stat -e task-clock,cycles,instructions,cache-references,cache-misses ./solve -p ../MDPs/evaluated/dap_200x100x10x10.mdp -method ftvi > op_dap_200x100x10x10_clust_noanneal 2>dap_200_clust_noann_perf
...
perf stat -e task-clock,cycles,instructions,cache-references,cache-misses ./solve -p ../MDPs/evaluated/dap_100x100x10x10.mdp -method ftvi > op_dap_100x100x10x10_noclust 2>dap_100_noclust_perf
#noclust and 4M
cp solve.c.4MInitial solve.c
make clean
make
...
perf stat -e task-clock,cycles,instructions,cache-references,cache-misses ./solve -p ../MDPs/evaluated/dap_200x100x10x10.mdp -method ftvi >op_dap_200x100x10x10_noclust 2>dap_200_noclust_perf
